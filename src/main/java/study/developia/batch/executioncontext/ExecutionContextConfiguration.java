...
public class ExecutionContextConfiguration {
    ...
    public Step executionContextStep1() {
        return stepBuilderFactory.get("execution context step1")
    ...
    public Step executionContextStep2() {
        return stepBuilderFactory.get("execution context step2")
    ...
    public Step executionContextStep3() {
        return stepBuilderFactory.get("execution context step3")
    ...
    public Step executionContextStep4() {
        return stepBuilderFactory.get("execution context step4")
